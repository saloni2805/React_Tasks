      ...
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            ...
            {/* product  */}
            <TabPanel>
              <div className="  px-4 md:px-2 mb-16">
                <h1
                ...
                <div className="relative overflow-x-auto ">
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                    ...
                    {product.map((product, index) => {
                      const { title, price, category, imageUrl, date } = product
                      return (
                        <tbody key={index}>
                          <tr
              ...
              <div className="relative overflow-x-auto mb-16 mx-5">
                ...
                {order.map((allorder, index) => {
                  ...
                  return (
                    <table
                      key={index}
                      className="w-full text-sm text-left text-gray-500 dark:text-gray-400 mt-4"
                    >
                      <thead
